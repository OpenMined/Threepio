...
class KerasSpider(CrawlSpider):
    name = "keras"  # Name of web crawler
    version = "2.3.0"  # Version of sklearn module to crawl
    allowed_domains = ['keras.io']  # Crawl only links from Keras
    start_urls = ['https://keras.io/api/']  # Base URL
    ...
    # https://keras.io/api/ to look for
    # the selector '.section tbody td:first-child p' to extract links.
    # The response of the links direct to different Keras packages.
