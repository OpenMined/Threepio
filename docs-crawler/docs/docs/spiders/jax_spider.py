...
# Crawl modules in the JAX docs to extract functions
#
...
class JaxSpider(CrawlSpider):
    name = "jax"  # Name of web crawler
    version = "0.1.59"  # Version of JAX module to crawl
    allowed_domains = ['jax.readthedocs.io']  # Crawl only links from JAX
    start_urls = ['https://jax.readthedocs.io/']  # Base URL for crawling
    ...
    # https://jax.readthedocs.io/ to look for
    # the selector '.toctree-l1' to extract links.
    # The response of the links direct to different JAX packages.
    ...
    def parse_api(self, response):
        ...
        for selector in fdef:
            ...
            # For example, in the format - jax.random.PRNGKey(seed)¶
